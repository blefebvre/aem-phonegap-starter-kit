window.starterKit = window.starterKit || {};

(function(contentUtils, contentUpdate, undefined) {

    /**
     * Functional constructor for starterKit.contentPackageSwitcher. Assumes 
     * `deviceready` event has already fired.
     */
    starterKit.contentPackageSwitcher = function(spec) {
